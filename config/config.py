...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "TRIXIE MUSIC")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TeamLegend77/TrixieMusic",
)
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/7fe6af05e795a73ede7af.jpg")
